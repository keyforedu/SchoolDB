...
public class DataAlumni extends JFrame implements ActionListener
{
    ...
    public DataAlumni (Homepage homepage)
    {
        ...
        // Menu Button
        view_button = new JButton("View Data");
        view_button.setPreferredSize(new DimensionUIResource(200, 50));
        ...
        // Setting Page
        setTitle("Alumni Database Information");
        setSize(1000, 600);
